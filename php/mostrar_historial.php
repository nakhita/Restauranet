...
<?php
	...
	$query = "SELECT C.comentario, C.estrellas, U.nombres FROM calificaciones C JOIN reservas R ON C.idreserva = R.idreserva JOIN usuario U ON R.idcliente = U.ID_US
	WHERE R.ID_RES = '$idrestaurant' ORDER BY estrellas DESC";
